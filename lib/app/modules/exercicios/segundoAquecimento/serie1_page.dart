...
class PrimeiraSerieSegundo extends StatelessWidget {
  const PrimeiraSerieSegundo({Key? key}) : super(key: key);
        ...
        child: Stack(
          children: [
            OncoativExercicioSerie(
              ...
              onPressed: () {
                Get.toNamed('/exercicios/segundoAquecimento/primeirodescanso');
              },
            ),
          ],
        ),
