...
class IndexAquecimentoSegundo extends StatelessWidget {
  const IndexAquecimentoSegundo({Key? key}) : super(key: key);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          OncoativButtonGradientIcon(
                              ...
                              onPressed: () {
                                Get.toNamed(
                                    '/exercicios/segundoAquecimento/primeiroaquecimento');
                              }),
                        ],
                      ),
                    ),
